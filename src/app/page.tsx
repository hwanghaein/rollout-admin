      ...
      <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
        ...
        <div className="col-span-2 bg-gray-200 dark:bg-gray-800 p-4 rounded-lg shadow-md text-dark2 dark:text-gray-200 text-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link href="/cost">
              <button className="p-4 bg-brown1 text-white rounded-lg w-full hover:bg-brown2 dark:bg-brown2 dark:hover:bg-brown2 dark:border dark:border-gray-700 ">
                단가 계산
              </button>
            </Link>
            <Link href="/recipe">
        ...
        <div className="col-span-2 p-4 text-dark2 dark:text-gray-200 text-center bg-gray-200 dark:bg-gray-800 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link href="/menu">
              <button className="p-4 bg-brown1 text-white rounded-lg w-full cursor-pointer hover:bg-brown2 dark:bg-brown2 dark:hover:bg-brown2 dark:border dark:border-gray-700">
                메뉴
              </button>
            </Link>
            <Link href="/store">
